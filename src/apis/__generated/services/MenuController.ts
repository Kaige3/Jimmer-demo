...
export class MenuController {
    ...
    async delete(options: MenuControllerOptions['delete']): Promise<
        boolean | undefined
    > {
    ...
    async findById(options: MenuControllerOptions['findById']): Promise<
    ...
    async query(options: MenuControllerOptions['query']): Promise<
    ...
    async save(options: MenuControllerOptions['save']): Promise<
        string
    > {
        let _uri = '/menu/save';
